...
// extends sinaliza que a classe Funcionário é uma subclasse da classe Pessoa
public class Funcionario extends Pessoa {
    ...
    public void imprime() {
        // super.imprime() chama a versão do método imprime() definida na classe Pessoa (superclasse)
        super.imprime();
